  ...
  <q-card-section>
    ...
    >
      <div class="col-10 q-mb-xs">
        <div class="text-h8 text-center text-grey-3">Search Song On Spotify</div>
      </div>
      <div class="col-10 q-mb-xs">
        <q-select
          dark
...
export default {
  ...
  methods: {
    ...
    clearSongSearch () {
      console.log('SpotifyTextSearch: clearSongSearch()')
      this.song = {
        trackId: null,
        name: null,
        label: null,
    ...
    searchSong (val, update, abort) {
      console.log('SpotifyTextSearch: searchSong()')
      if (val.length < 2) {
        abort()
        return
      }
    ...
    selectSong (selectedSong) {
      console.log('SpotifyTextSearch: selectSong()')
      if (selectedSong) {
    ...
    loadSong () {
      console.log('SpotifyTextSearch: TOKEN USED:', this.token)
      console.log('SpotifyTextSearch: loadSong()')
      console.log('SpotifyTextSearch: trackId:', this.song.trackId)
